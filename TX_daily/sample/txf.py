...
# ====== 參數設定區 ======
TARGET_URL = "https://www.taifex.com.tw/cht/3/futContractsDate"  # 目標網址
CSV_FILE = 'txf_data.csv'  # 儲存資料的 CSV 檔案名稱
...
def extract_table_data(soup, date, num_rows):
    """提取目標表格中的數據"""
...
def main():
    ...
    table_data = extract_table_data(soup, date, NUM_ROWS_TO_EXTRACT)
